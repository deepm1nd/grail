...
Then fetch whichever files within that repository's `agents/` directory `CLAUDE.md` (and
...
At the start of the session, once `CLAUDE.md` is fetched, note the commit/version it
