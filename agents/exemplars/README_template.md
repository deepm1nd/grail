...
[![Coverage](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/coverage.toml&query=coverage.percent&suffix=%25&label=coverage&color=brightgreen)](metrics/coverage.toml)
[![Tests](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/tests.toml&query=tests.passed&label=tests%20passing&color=brightgreen)](metrics/tests.toml)
[![Security Audit](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/audit.toml&query=audit.status&label=security%20audit)](metrics/audit.toml)
[![License Check](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/deny.toml&query=deny.status&label=license%20check)](THIRD_PARTY_LICENSES.md)
[![License Violations](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/licenses.toml&query=licenses.violations_count&label=license%20violations&color=brightgreen)](metrics/license_violations_log.jsonl)
[![Crates Added](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/licenses.toml&query=licenses.crates_added_count&label=crates%20added&color=blue)](metrics/license_additions_log.jsonl)
[![Branch Status](https://img.shields.io/badge/dynamic/toml?url=https://raw.githubusercontent.com/[org]/[repo]/[current_branch]/metrics/source.toml&query=source.status&label=latest%20push)](metrics/source.toml)
...
regenerated by CI on every push to the **current phase's branch** (`agents/CI.md` Stage 8)
— do not hand-edit them.

> **`[current_branch]` note:** metrics are committed to whichever branch CI last ran on,
> not to `main` — the badge URLs above MUST point at the actual current phase Branch Name
> (`agents/exemplars/development_plan_template.md` §6.1), substituted in place of the
> literal `[current_branch]` placeholder. Because the branch changes every phase, this is
> **not a one-time substitution at Design time** — every phase's Phase-End Quality
> Assurance step (`agents/DEVELOPMENT.md` §5.2) re-checks and updates these URLs to the
> new phase's Branch Name, along with confirming `[org]`/`[repo]` are still correctly
> substituted.
